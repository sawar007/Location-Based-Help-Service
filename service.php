...
<div class="container">
    <div class="row bg-light shadow p-3 mb-5 bg-white rounded"> 
      <div  style= "padding:20px" class="col-12  text-align">
        <p> Here you can serach for donation availble in your area  </p>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control m-2" id="email" name="Name" placeholder="Try Dwarka or New delhi">
  </div>
  <div class="form-group">
    
     <center><button type="submit" name="submit"  class="btn btn-primary ">Search</button></center> 
  </div>
...
$search = $_POST['Name'];
 ...
 $sql = "SELECT * FROM donate1 WHERE City LIKE '%" .$search . "%' OR State LIKE '%" .$search . "%' OR Name LIKE '%" .$search .  "%' OR donation LIKE '%" .$search ."%'   ";
 ...
 $row_class = 'row  bg-light shadow p-3 bg-white rounded n';    // Row class name
