...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script></html>';
}

  else {
    echo '<h1>Please login first</h1><br>  <a  href="login.php" target="_blank">Login</a>';
  }
...
if(isset($_POST['submit']))
{
  ...
  $query = "insert into profile(Name, Phone, Address, Address1, City, State, Zip,userid)  values('$name','$phone', '$sad','$sad1','$city','$state','$zip',$id)";
